...
// source: blackfury/claimsmanager/v1/query.proto
...
func (*QueryClaimsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_3bd6eb8519ef4c68, []int{0}
}
...
func (*QueryClaimsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_3bd6eb8519ef4c68, []int{1}
}
...
func init() {
	proto.RegisterType((*QueryClaimsRequest)(nil), "blackfury.claimsmanager.v1.QueryClaimsRequest")
	proto.RegisterType((*QueryClaimsResponse)(nil), "blackfury.claimsmanager.v1.QueryClaimsResponse")
}

func init() {
	proto.RegisterFile("blackfury/claimsmanager/v1/query.proto", fileDescriptor_3bd6eb8519ef4c68)
}

var fileDescriptor_3bd6eb8519ef4c68 = []byte{
	// 540 bytes of a gzipped FileDescriptorProto
	,
}
...
func (c *queryClient) Claims(ctx context.Context, in *QueryClaimsRequest, opts ...grpc.CallOption) (*QueryClaimsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/blackfury.claimsmanager.v1.Query/Claims", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) LastEpochClaims(ctx context.Context, in *QueryClaimsRequest, opts ...grpc.CallOption) (*QueryClaimsResponse, error) {
	out := new(QueryClaimsResponse)
	err := c.cc.Invoke(ctx, "/blackfury.claimsmanager.v1.Query/LastEpochClaims", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) UserClaims(ctx context.Context, in *QueryClaimsRequest, opts ...grpc.CallOption) (*QueryClaimsResponse, error) {
	out := new(QueryClaimsResponse)
	err := c.cc.Invoke(ctx, "/blackfury.claimsmanager.v1.Query/UserClaims", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) UserLastEpochClaims(ctx context.Context, in *QueryClaimsRequest, opts ...grpc.CallOption) (*QueryClaimsResponse, error) {
	out := new(QueryClaimsResponse)
	err := c.cc.Invoke(ctx, "/blackfury.claimsmanager.v1.Query/UserLastEpochClaims", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Claims_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/blackfury.claimsmanager.v1.Query/Claims",
	}
...
func _Query_LastEpochClaims_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/blackfury.claimsmanager.v1.Query/LastEpochClaims",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_UserClaims_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/blackfury.claimsmanager.v1.Query/UserClaims",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_UserLastEpochClaims_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/blackfury.claimsmanager.v1.Query/UserLastEpochClaims",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "blackfury.claimsmanager.v1.Query",
	...
	Metadata: "blackfury/claimsmanager/v1/query.proto",
}

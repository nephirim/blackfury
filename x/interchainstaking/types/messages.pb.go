...
// source: blackfury/interchainstaking/v1/messages.proto
...
func (*MsgRequestRedemption) Descriptor() ([]byte, []int) {
	return fileDescriptor_2176e54dc383043c, []int{0}
}
...
func (*MsgSignalIntent) Descriptor() ([]byte, []int) {
	return fileDescriptor_2176e54dc383043c, []int{1}
}
...
func (*MsgRequestRedemptionResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_2176e54dc383043c, []int{2}
}
...
func (*MsgSignalIntentResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_2176e54dc383043c, []int{3}
}
...
func init() {
	proto.RegisterType((*MsgRequestRedemption)(nil), "blackfury.interchainstaking.v1.MsgRequestRedemption")
	proto.RegisterType((*MsgSignalIntent)(nil), "blackfury.interchainstaking.v1.MsgSignalIntent")
	proto.RegisterType((*MsgRequestRedemptionResponse)(nil), "blackfury.interchainstaking.v1.MsgRequestRedemptionResponse")
	proto.RegisterType((*MsgSignalIntentResponse)(nil), "blackfury.interchainstaking.v1.MsgSignalIntentResponse")
}

func init() {
	proto.RegisterFile("blackfury/interchainstaking/v1/messages.proto", fileDescriptor_2176e54dc383043c)
}

var fileDescriptor_2176e54dc383043c = []byte{
	// 628 bytes of a gzipped FileDescriptorProto
	,
}
...
func (c *msgClient) RequestRedemption(ctx context.Context, in *MsgRequestRedemption, opts ...grpc.CallOption) (*MsgRequestRedemptionResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/blackfury.interchainstaking.v1.Msg/RequestRedemption", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) SignalIntent(ctx context.Context, in *MsgSignalIntent, opts ...grpc.CallOption) (*MsgSignalIntentResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/blackfury.interchainstaking.v1.Msg/SignalIntent", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) GovCloseChannel(ctx context.Context, in *MsgGovCloseChannel, opts ...grpc.CallOption) (*MsgGovCloseChannelResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/blackfury.interchainstaking.v1.Msg/GovCloseChannel", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) GovReopenChannel(ctx context.Context, in *MsgGovReopenChannel, opts ...grpc.CallOption) (*MsgGovReopenChannelResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/blackfury.interchainstaking.v1.Msg/GovReopenChannel", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_RequestRedemption_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/blackfury.interchainstaking.v1.Msg/RequestRedemption",
	}
...
func _Msg_SignalIntent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/blackfury.interchainstaking.v1.Msg/SignalIntent",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_GovCloseChannel_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/blackfury.interchainstaking.v1.Msg/GovCloseChannel",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_GovReopenChannel_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/blackfury.interchainstaking.v1.Msg/GovReopenChannel",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "blackfury.interchainstaking.v1.Msg",
	...
	Metadata: "blackfury/interchainstaking/v1/messages.proto",
}

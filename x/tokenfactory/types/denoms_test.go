...
func TestDeconstructDenom(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		},
		{
			...
			denom:            "factory/fury1ve2nremzdnu7e55khlrt2282qhh98dh4ssnxaj/bitcoin/1",
			expectedSubdenom: "bitcoin/1",
		},
		{
			desc:             "no subdenom",
			denom:            "factory/fury1ve2nremzdnu7e55khlrt2282qhh98dh4ssnxaj/",
			expectedSubdenom: "",
		},
		{
			desc:  "incorrect prefix",
			denom: "ibc/fury1ve2nremzdnu7e55khlrt2282qhh98dh4ssnxaj/bitcoin",
			err:   types.ErrInvalidDenom,
		},
		{
		...
		{
			desc:  "too long name",
			denom: "factory/fury1ve2nremzdnu7e55khlrt2282qhh98dh4ssnxaj/adsfadsfadsfadsfadsfadsfadsfadsfadsfadsfadsfadsfadsfadsfadsfadsfadsfadsfadsfadsfadsfadsfadsfadsfadsfadsfadsfadsfadsfadsfadsfadsfadsfadsfadsfadsfadsfadsfadsfadsfadsf",
			err:   types.ErrInvalidDenom,
		},
	} {
		t.Run(tc.desc, func(t *testing.T) {
			expectedCreator := "fury1ve2nremzdnu7e55khlrt2282qhh98dh4ssnxaj"
...
func TestGetTokenDenom(t *testing.T) {
	for _, tc := range []struct {
		...
		{
			desc:     "normal",
			creator:  "fury1ve2nremzdnu7e55khlrt2282qhh98dh4ssnxaj",
			subdenom: "bitcoin",
			valid:    true,
		},
		{
		...
		{
			desc:     "too long name",
			creator:  "fury1ve2nremzdnu7e55khlrt2282qhh98dh4ssnxajffffffffffffffffffffffffffffffffff",
			subdenom: ".",
			valid:    false,
		},
		{
		...
		},
		{
			...
			creator:  "fury1ve2nremzdnu7e55khlrt2282qhh98dh4ssnxajkhanhanchaucascascascas",
			subdenom: "bitcoin",
			valid:    true,
		},
	} {
